...
class FakeEnv_SSM:
    ...
    def step(self, obs, act, deterministic=False):
        ...
        ensemble_model_means, ensemble_model_vars = self.model.predict(inputs, factored=True) # ensemble_model_mean is p(s', r|s, a)

        ensemble_model_means[:, :, 1:] += obs # TODO: why adding obs?
